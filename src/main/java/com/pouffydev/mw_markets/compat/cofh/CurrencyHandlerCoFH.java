package com.pouffydev.mw_markets.compat.cofh;
...
public class CurrencyHandlerCoFH {
    public static int coFHInventoryValue;
    
    public CurrencyHandlerCoFH() {
    }
    ...
    public static void updateInventoryValue(Player player) {
        ...
        for (JsonElement jsonElement : currency) {
            ...
            for (ItemStack itemStack : player.getInventory().items) {
                ...
                coFHInventoryValue = newInventoryValue;
            }
        }
    }
}
